      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {leftPanelCollapsed && (
          <button
            ...
            className="absolute top-20 left-4 z-10 p-3 bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-400 dark:border-gray-600 shadow-xl hover:border-blue-500 dark:hover:border-blue-400 transition-all"
            title="Expand panel"
          >
          ...
          <ResizableDivider
            ...
            <div className="h-full flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800">
              ...
              <div className="flex-1 flex flex-col p-6 md:p-8 overflow-y-auto">
                ...
                {/* Session History at Bottom - Always visible */}
                <div className="mt-6">
